"""
Django settings for ninjaguerreiro project.
...
CORS_ALLOWED_ORIGINS = [env('CORS_ALLOWED_ORIGINS', default='http://127.0.0.1:3000, http://localhost:3000').split(',')]
...
ROOT_URLCONF = 'ninjaguerreiro.urls'
...
WSGI_APPLICATION = 'ninjaguerreiro.wsgi.application'
